  ...
  items: [
    {
      ...
      logoClassName: "max-h-32 max-w-[260px] sm:max-h-40 sm:max-w-[340px]",
    },
    {
      id: "daamin",
      name: "Daamin",
      ...
      wrapperClassName: "min-w-[190px] sm:min-w-[230px]",
      logoClassName: "max-h-32 max-w-[250px] sm:max-h-40 sm:max-w-[320px]",
    },
    {
      id: "element-fitness",
      ...
      logoClassName: "max-h-24 max-w-[210px] opacity-100 [filter:grayscale(1)_brightness(1.85)_contrast(1.08)] sm:max-h-28 sm:max-w-[250px]",
    },
    {
    ...
    },
    {
      ...
      logoClassName: "max-h-32 max-w-[270px] sm:max-h-40 sm:max-w-[360px]",
    },
    {
      ...
      wrapperClassName: "min-w-[190px] sm:min-w-[230px]",
      logoClassName: "max-h-36 max-w-[250px] opacity-100 sm:max-h-44 sm:max-w-[320px]",
    },
    {
      id: "the-crockrenza",
      name: "The Crockrenza",
    ...
    },
    {
      ...
      wrapperClassName: "min-w-[200px] sm:min-w-[240px]",
      logoClassName: "max-h-36 max-w-[280px] sm:max-h-44 sm:max-w-[370px]",
    },
    {
      id: "zareyah-clothing",
